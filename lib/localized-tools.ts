...
export const LOC_TOOLS: LocTool[] = [
  ...
  },
  {
    ...
    ru: {
      ...
      h1: "Сжать PDF",
      desc: "Уменьшите размер PDF онлайн — картинки пережимаются, текст остаётся резким. Бесплатно и без регистрации.",
      ...
      faqs: [
        ...
        { q: "Это безопасно?", a: "Сжатие выполняется на сервере QRix: файл обрабатывается в памяти, отдаётся вам обратно и нигде не сохраняется." },
    ...
    uz: {
      ...
      h1: "PDF siqish",
      desc: "PDF hajmini kichraytiring — rasmlar siqiladi, matn aniq qoladi. Bepul va ro'yxatdan o'tmasdan.",
      ...
      faqs: [
        ...
        { q: "Xavfsizmi?", a: "Siqish QRix serverida bajariladi: fayl xotirada ishlanadi, sizga qaytariladi va hech qayerda saqlanmaydi." },
