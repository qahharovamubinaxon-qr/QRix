...
export const VIDEO_TOOLS: VideoTool[] = [
  ...
  },
  {
    ...
    desc: "Translate an entire .srt subtitle file to another language while keeping every timestamp — free neural translation.",
    emoji: "🌍", grad: "linear-gradient(135deg,#60a5fa,#1d4ed8)", category: "Subtitles",
    engine: "srt-translate", status: "live",
    keywords: ["translate subtitles", "srt translator", "subtitle translation", "translate srt file"],
    intro: "Same timing, new language — free neural subtitle translation.",
