...
export const RESIZE_PRESETS: ResizePreset[] = [
  ...
  {
    slug: "1080x1920", w: 1080, h: 1920, group: "Display", label: "Vertical 9:16", emoji: "📱",
    title: "Resize Image to 1080x1920 — Free Vertical Resizer",
    h1: "Resize an image to 1080×1920",
    desc: "Resize an image to exactly 1080x1920 online and free — the full-screen vertical 9:16 size for phone wallpapers and story-style posts.",
    intro: "Hit exactly 1080×1920 — the full-screen vertical size a phone display fills edge to edge.",
    about: "1080×1920 is Full HD turned on its side: the native resolution of a great many phone screens and the standard for anything meant to fill one completely, from lock-screen wallpapers to vertical video covers and story-format posts. It is a tall 9:16 frame, which is the opposite shape of almost every photo taken in landscape, so a horizontal source will lose most of its width in fill mode. Portrait shots map onto it far more comfortably. When a landscape image genuinely has to be used, fit is usually the better answer — the whole picture stays visible with coloured bands above and below, which reads as a deliberate design choice rather than a botched crop.",
    keywords: ["resize image to 1080x1920", "1080x1920 image resizer", "vertical image size", "phone wallpaper size", "9:16 image resizer"],
    steps: steps("Fill crops to the tall 9:16 frame; fit keeps the whole image between coloured bands.", "Save your 1080×1920 image."),
    faqs: [
      { q: "Why does my landscape photo lose so much in 1080x1920?", a: "A 9:16 frame is much taller than it is wide, so covering it with a landscape photo means cropping away most of the left and right. Fit mode keeps the whole image and pads above and below instead." },
      { q: "Is 1080x1920 the right size for a phone wallpaper?", a: "It fills a 1080p phone screen exactly. Higher-resolution phones will upscale it slightly, so use 1440×2560 if your device has a QHD display." },
      { q: "Is this the same as a story-format image?", a: "Yes — 1080×1920 is the standard full-screen vertical size used by story and short-video formats across platforms." },
      { q: "Can I use a portrait photo without cropping?", a: "Often yes. Portrait photos are already tall, so many need only a small trim, and the preview shows you exactly what fill will remove." },
      privacyFaq,
    ],
  },
  {
    slug: "1600x900", w: 1600, h: 900, group: "Display", label: "HD+ 16:9", emoji: "🖵",
    title: "Resize Image to 1600x900 — Free Online Resizer",
    h1: "Resize an image to 1600×900",
    desc: "Resize an image to exactly 1600x900 pixels online for free — a lighter 16:9 size for web headers, blog images and laptop wallpapers.",
    intro: "Hit exactly 1600×900 — a lighter 16:9 frame for web headers and blog images.",
    about: "1600×900 is the practical middle ground of the 16:9 family: noticeably lighter than 1920×1080 while still wide and sharp enough for a hero banner, a blog header or an article illustration. That weight difference matters on the web, where a header image is often the largest single asset on a page and directly affects how quickly it feels ready. It is also the native resolution of a long tail of budget laptops, which makes it a sensible wallpaper target. Since it shares the exact 16:9 shape of 1080p and 4K, moving between those sizes is a clean scale with no cropping at all — only a change in pixel count.",
    keywords: ["resize image to 1600x900", "1600x900 image resizer", "blog header image size", "web banner size", "make image 1600x900"],
    steps: steps("Fill crops to the 16:9 frame; fit keeps the whole image on a background colour.", "Save your 1600×900 image."),
    faqs: [
      { q: "Why choose 1600x900 over 1920x1080?", a: "It is the same shape with roughly 30% fewer pixels, so the file is lighter. For a web header that is a real speed gain, and the difference is invisible at typical display sizes." },
      { q: "Is 1600x900 good for a blog header?", a: "Yes — it is wide enough to look generous across a content column and light enough not to dominate page weight. Compress it afterwards for a further reduction." },
      { q: "Can I scale a 1600x900 image up to 1080p later?", a: "You can, and the shape matches so nothing is cropped, but the result will be slightly softer than exporting at 1920×1080 from the original." },
      { q: "Does it work as a laptop wallpaper?", a: "It fits 1600×900 laptop panels exactly. On a 1080p screen it will be stretched a little, so export at 1920×1080 for those." },
      privacyFaq,
    ],
  },
  {
    slug: "1920x1200", w: 1920, h: 1200, group: "Display", label: "WUXGA 16:10", emoji: "🗖",
    title: "Resize Image to 1920x1200 — Free 16:10 Resizer",
    h1: "Resize an image to 1920×1200",
    desc: "Resize an image to exactly 1920x1200 online free — the WUXGA 16:10 size used by many productivity monitors and laptop displays.",
    intro: "Hit exactly 1920×1200 — the 16:10 size productivity monitors and many laptops use.",
    about: "1920×1200 is WUXGA, a 16:10 frame that is quietly making a comeback: monitors and laptops aimed at writing and coding increasingly favour it because the extra 120 pixels of height show more of a document or a file tree than 1080p does. That taller shape is exactly why a 1080p wallpaper looks wrong on one — stretched vertically or cropped at the sides — and why it is worth exporting at the native size instead. A 16:9 source resized here needs a little off the sides in fill mode, or a pair of coloured bands in fit mode. Photos shot in 3:2, the common DSLR ratio, sit closer to 16:10 and need less trimming.",
    keywords: ["resize image to 1920x1200", "1920x1200 wallpaper size", "16:10 image resizer", "wuxga image size", "make image 1920x1200"],
    steps: steps("Fill crops to the 16:10 frame; fit keeps the whole image between coloured bands.", "Save your 1920×1200 image."),
    faqs: [
      { q: "What is the difference between 1920x1200 and 1920x1080?", a: "Same width, 120 more pixels of height. 1920×1200 is 16:10 and slightly taller, which is why a 1080p wallpaper does not fit a 16:10 screen correctly." },
      { q: "Why do some monitors use 16:10?", a: "The extra vertical space suits documents, spreadsheets and code, where height is more useful than width. It is common on productivity monitors and many laptops." },
      { q: "Will my 16:9 photo be cropped?", a: "Slightly, at the left and right, since 16:10 is relatively taller. Fit mode avoids that by padding the top and bottom instead." },
      { q: "Is 1920x1200 sharper than 1080p?", a: "It has about 11% more pixels, so on a native 16:10 panel it is marginally more detailed — but the real benefit is that it fits without stretching." },
      privacyFaq,
    ],
  },
  {
    slug: "1024x1024", w: 1024, h: 1024, group: "Web", label: "Large square", emoji: "🟦",
    title: "Resize Image to 1024x1024 — Free Square Resizer",
    h1: "Resize an image to 1024×1024",
    desc: "Resize an image to exactly 1024x1024 pixels online and free — the large square used for app icons, AI image inputs and high-DPI tiles.",
    intro: "Hit exactly 1024×1024 — the large square used for app icons and AI image workflows.",
    about: "1024×1024 has become the default large square: it is the master size Apple asks for when submitting an app icon, the native output of many image-generation models, and a comfortable source for any tile that has to stay sharp on a high-DPI screen. Being a power of two also makes it well behaved as a texture in graphics pipelines. As a source file it is genuinely useful — you can scale it down to 512, 256 or 128 cleanly, whereas going the other way never works as well. Fill crops a rectangular photo to a centred square; fit preserves an entire logo or icon artwork against a background colour you choose, which is usually the right call for anything with fine edges.",
    keywords: ["resize image to 1024x1024", "1024x1024 image resizer", "app icon size", "large square image", "ai image size 1024"],
    steps: steps("Fill crops a centred square; fit keeps the whole artwork on a background colour.", "Save your 1024×1024 square."),
    faqs: [
      { q: "Why is 1024x1024 used for app icons?", a: "It is the master size app stores request, from which every smaller icon size is generated. Supplying it at full resolution keeps all the derived sizes crisp." },
      { q: "Is 1024x1024 a good size for AI image tools?", a: "It is the native output of many image models, so working at that size avoids an extra resampling step that can soften detail." },
      { q: "Can I scale 1024x1024 down to smaller icons?", a: "Yes, and cleanly — it divides evenly into 512, 256, 128 and 64, which is part of why the size is so widely used." },
      { q: "Should I use fill or fit for a logo?", a: "Fit. It keeps the entire logo visible and pads the remaining space, so no part of the mark is ever clipped." },
      privacyFaq,
    ],
  },
  {
    slug: "2048x2048", w: 2048, h: 2048, group: "Web", label: "XL square", emoji: "🟪",
    title: "Resize Image to 2048x2048 — Free XL Square Resizer",
    h1: "Resize an image to 2048×2048",
    desc: "Resize an image to exactly 2048x2048 pixels online free — an extra-large square for print-quality tiles, textures and archival masters.",
    intro: "Hit exactly 2048×2048 — an extra-large square for textures, masters and print-quality tiles.",
    about: "2048×2048 is the square you keep as a master. It holds enough detail to print a respectable square photo, to serve as a texture in a 3D or game pipeline where power-of-two dimensions are expected, and to survive being scaled down to every smaller square you might need later without ever having to upscale. The trade-off is weight: over four million pixels makes for a substantial file, so it is a poor choice for anything that loads on a page. Export a 2048 master, then derive 1024, 512 and 400 versions from it for actual use. Fill crops a rectangular source to square; fit preserves the whole frame on a background colour of your choosing.",
    keywords: ["resize image to 2048x2048", "2048x2048 image resizer", "texture size power of two", "large square image", "square master image"],
    steps: steps("Fill crops a centred square; fit keeps the whole image on a background colour.", "Save your 2048×2048 square."),
    faqs: [
      { q: "Why are power-of-two sizes like 2048 used for textures?", a: "Graphics hardware and mipmapping pipelines handle power-of-two dimensions most efficiently, which is why 512, 1024 and 2048 are the conventional texture sizes." },
      { q: "Is 2048x2048 too large for a website?", a: "Usually yes. Keep it as a master and serve a 1024 or smaller derivative — a 2048 square is a heavy download for a page element." },
      { q: "Can I print a 2048x2048 image?", a: "At 300 DPI it prints just under 7×7 inches, which suits a square photo print or an album insert." },
      { q: "Will upscaling a small image to 2048 help?", a: "No. It produces a large file without adding detail. A master is only worth keeping if the original genuinely had the resolution." },
      privacyFaq,
    ],
  },
  {
    slug: "300x300", w: 300, h: 300, group: "Web", label: "Small square", emoji: "◽",
    title: "Resize Image to 300x300 — Free Small Square Resizer",
    h1: "Resize an image to 300×300",
    desc: "Resize an image to exactly 300x300 pixels online and free — a compact square for avatars, badges and directory listings.",
    intro: "Hit exactly 300×300 — a compact square for avatars, badges and directory listings.",
    about: "300×300 sits in the useful gap between a thumbnail and a full avatar: big enough that a face or a logo still reads clearly, small enough that the file stays trivially light and slips under most upload limits. Directory listings, forum profiles, badge images and internal tools frequently settle on roughly this size. Because the square is modest, tight cropping matters — a wide photo reduced to 300 pixels leaves very little room for a subject that was small in the frame to begin with. Fill crops to a centred square, fit preserves the whole image against a background colour, and lowering the quality slider will squeeze the file further if a strict limit is the actual obstacle.",
    keywords: ["resize image to 300x300", "300x300 image resizer", "small square image", "avatar size 300", "make image 300x300"],
    steps: steps("Fill crops tight to a centred square; fit keeps the whole image on a background colour.", "Save your 300×300 image."),
    faqs: [
      { q: "Is 300x300 big enough for a profile picture?", a: "For most forums and directories, yes. Platforms that render avatars on high-DPI screens may prefer 400×400 or larger, so check any stated minimum." },
      { q: "My subject looks tiny at 300x300 — what should I do?", a: "Crop in on the subject before resizing. At this size there are not enough pixels for anything small in the original frame to stay legible." },
      { q: "How do I get under a strict file-size limit?", a: "Use the quality slider. It reduces file size while the image stays exactly 300×300." },
      { q: "Does 300x300 mean 300 DPI?", a: "No — these are pixel dimensions, not resolution. DPI only matters when printing, and a 300×300 file prints at just one inch square at 300 DPI." },
      privacyFaq,
    ],
  },
  {
    slug: "2400x3000", w: 2400, h: 3000, group: "Print", label: "8×10 inch print", emoji: "🖼",
    title: "Resize Photo to 2400x3000 — 8x10 Inch Print Size",
    h1: "Resize a photo to 2400×3000",
    desc: "Resize a photo to exactly 2400x3000 pixels online free — the 8x10 inch print size at 300 DPI for framed portraits and enlargements.",
    intro: "Hit exactly 2400×3000 — an 8×10 inch print at the full 300 DPI labs ask for.",
    about: "8×10 inches is the classic enlargement: framed portraits, graduation photos, and the print you hang rather than file away. At 300 DPI it comes to 2400×3000 pixels. The frame is 4:5, which is a distinctly different shape from both the 2:3 of a 4×6 and the 4:3 of most phone photos, so a crop is nearly always involved — and at this size a careless one is very visible. Choose it yourself here rather than letting the lab's software decide. Resolution matters more at 8×10 than at any smaller print: softness that passes unnoticed on a 4×6 becomes obvious once the same file is enlarged, so always start from the original rather than a resized copy.",
    keywords: ["2400x3000 photo size", "8x10 print size pixels", "resize photo for 8x10", "8x10 photo dimensions", "print enlargement resizer"],
    steps: steps("Fill crops to the 4:5 print ratio; fit keeps the whole photo inside a coloured border.", "Save your print-ready 2400×3000 photo."),
    faqs: [
      { q: "How many pixels is an 8x10 inch print?", a: "2400×3000 at 300 DPI. Below roughly 200 DPI — about 1600×2000 — an enlargement of this size starts to look visibly soft." },
      { q: "Why does my phone photo need cropping for 8x10?", a: "Phone photos are usually 4:3 while an 8×10 is 4:5, a taller shape. Something has to come off the sides, so it is better to choose what than to let the lab guess." },
      { q: "Can I print an 8x10 from a 12-megapixel photo?", a: "Yes. A 12 MP image is around 4000×3000, comfortably more than the 2400×3000 needed, so it downscales cleanly." },
      { q: "Does the same crop work for 5x7 and 8x10?", a: "No — 5×7 and 8×10 are different ratios, so each print size needs its own crop from the original." },
      privacyFaq,
    ],
  },
  {
    slug: "1748x2480", w: 1748, h: 2480, group: "Print", label: "A5 at 300 DPI", emoji: "📃",
    title: "Resize Image to 1748x2480 — A5 Size at 300 DPI",
    h1: "Resize an image to 1748×2480",
    desc: "Resize an image to exactly 1748x2480 pixels online free — full-page A5 at 300 DPI for flyers, leaflets, invitations and booklets.",
    intro: "Hit exactly 1748×2480 — a full A5 page at the 300 DPI printers ask for.",
    about: "A5 is 148×210 millimetres, exactly half an A4 sheet, and at 300 DPI that is 1748×2480 pixels. It is the workhorse size for flyers, leaflets, invitations, programmes and booklet pages — large enough to carry a real image and a block of text, small enough to hand out cheaply in quantity. Because every A-series size shares the same 1:√2 proportion, an A5 design scales up to A4 or down to A6 with no cropping whatsoever, which makes it a convenient size to design at when the final format is not yet settled. Keep important content clear of the outer few millimetres unless your printer supports full bleed, and use fit with a white background when the whole image must survive intact.",
    keywords: ["a5 size in pixels", "1748x2480 image", "resize image to a5", "a5 300 dpi pixels", "flyer size resizer"],
    steps: steps("Fill crops to the A5 page ratio; fit places the whole image on a coloured page.", "Save your print-ready 1748×2480 image."),
    faqs: [
      { q: "What is A5 in pixels?", a: "1748×2480 at 300 DPI. At 150 DPI it halves to 874×1240, which is acceptable for a rough proof but noticeably softer in print." },
      { q: "Is A5 exactly half of A4?", a: "Yes. Folding an A4 sheet in half gives A5, and because all A sizes share the 1:√2 ratio the proportions stay identical." },
      { q: "Can I scale an A5 design up to A4?", a: "Yes, with no cropping — the shapes match. Designing at A4 and scaling down is safer for print sharpness, though." },
      { q: "How much margin should I leave?", a: "A few millimetres at minimum. Most printers cannot print to the very edge, and anything closer risks being trimmed off." },
      privacyFaq,
    ],
  },
  {
    slug: "3508x4961", w: 3508, h: 4961, group: "Print", label: "A3 at 300 DPI", emoji: "📰",
    title: "Resize Image to 3508x4961 — A3 Size at 300 DPI",
    h1: "Resize an image to 3508×4961",
    desc: "Resize an image to exactly 3508x4961 pixels online free — full-page A3 at 300 DPI for posters, prints and large-format artwork.",
    intro: "Hit exactly 3508×4961 — a full A3 page at the 300 DPI print shops expect.",
    about: "A3 is 297×420 millimetres, twice the area of A4, and at 300 DPI it works out to 3508×4961 pixels. This is poster territory: event posters, wall prints, large-format artwork and presentation boards. It is also where source resolution stops being a detail and becomes the whole story — an image that looked perfectly sharp on screen can fall apart when enlarged to nearly five thousand pixels tall. Check what you are starting from before committing to A3, and consider an AI upscaler if the original is short. The exported file is large, so allow a moment for processing and use the quality slider to keep it manageable without visibly hurting a print viewed from a normal distance.",
    keywords: ["a3 size in pixels", "3508x4961 image", "resize image to a3", "a3 300 dpi pixels", "poster size resizer"],
    steps: steps("Fill crops to the A3 page ratio; fit places the whole image on a coloured page.", "Save your print-ready 3508×4961 image."),
    faqs: [
      { q: "What is A3 in pixels?", a: "3508×4961 at 300 DPI. Posters viewed from a distance can work at 150–200 DPI, but 300 is the standard specification." },
      { q: "Do I really need a 300 DPI file for a poster?", a: "It depends on viewing distance. A poster read from across a room tolerates less resolution than a print inspected up close, but print shops usually specify 300 DPI regardless." },
      { q: "My original is too small for A3 — what are my options?", a: "Either print smaller at A4, or upscale first. Upscaling sets the dimensions but cannot invent detail, so an AI upscaler will do better than a plain resize." },
      { q: "Why is the exported file so big?", a: "It contains over 17 million pixels. Lower the quality slider — at this resolution the reduction is very hard to see in print but the file shrinks considerably." },
      privacyFaq,
    ],
  },
];
