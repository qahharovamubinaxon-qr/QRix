...
export const AUTOPILOT_TOPICS: Topic[] = [
  ...
  /* ── PDF + image how-tos: the tools now localized for RU/UZ (Yandex is
        already sending traffic to these queries — sustain it with content) ── */
  {
    slug: "convert-pdf-to-word-keep-formatting",
    title: "How to Convert PDF to Word Without Losing Formatting (Free)",
    description: "PDF to Word conversions usually scramble tables and fonts. Here's how to convert a PDF to an editable Word file that keeps the layout 1:1 — free, no signup.",
    keywords: ["convert pdf to word", "pdf to word keep formatting", "pdf to word free no signup", "edit a pdf in word", "pdf to docx online"],
    category: "PDF", toolHref: "/pdf-tools/pdf-to-word", toolLabel: "Convert PDF to Word free",
    angle: "Explain WHY most converters break tables/columns (they rebuild layout from scratch), how a proper cloud engine preserves it, when OCR is needed (scans), and a step-by-step with QRix. Mention the RU/UZ audience gets localized pages. Practical, office-worker-friendly.",
    related: ["merge-pdf-files-free", "compress-pdf-without-losing-quality"],
  },
  {
    slug: "compress-pdf-without-losing-quality",
    title: "How to Compress a PDF Without Losing Quality (Free Online)",
    description: "Email bouncing your PDF for being too big? Here's how to shrink a PDF's size while keeping it readable — free, in the browser, nothing uploaded.",
    keywords: ["compress pdf", "reduce pdf size", "shrink pdf", "compress pdf without losing quality", "make pdf smaller free"],
    category: "PDF", toolHref: "/pdf-tools/compress", toolLabel: "Compress a PDF free",
    angle: "What actually makes a PDF big (images, embedded fonts), how compression balances size vs quality, typical size targets for email (25MB) and web uploads, and privacy (on-device). Step-by-step with QRix.",
    related: ["convert-pdf-to-word-keep-formatting", "merge-pdf-files-free"],
  },
  {
    slug: "merge-pdf-files-free",
    title: "How to Merge PDF Files Into One (Free, No Signup)",
    description: "Combine multiple PDFs into a single document in the right order — free, in your browser, with no watermark and nothing uploaded to a server.",
    keywords: ["merge pdf", "combine pdf files", "join pdf online", "merge pdf free", "put pdfs together"],
    category: "PDF", toolHref: "/pdf-tools/merge", toolLabel: "Merge PDFs free",
    angle: "When you need to merge (contracts, scans, reports), how to reorder pages, why on-device matters for sensitive docs, and a quick walkthrough. Note there is no file-count limit.",
    related: ["compress-pdf-without-losing-quality", "convert-pdf-to-word-keep-formatting"],
  },
  {
    slug: "remove-background-from-image-free",
    title: "How to Remove the Background From an Image Free (AI, 1 Click)",
    description: "Get a clean transparent PNG from any photo with AI — no manual selecting, no watermark, full resolution, free. Perfect for product shots and profile pictures.",
    keywords: ["remove background from image", "remove background free", "transparent background png", "erase background from photo", "background remover no watermark"],
    category: "AI", toolHref: "/ai-tools/background-remover", toolLabel: "Remove a background free",
    angle: "How AI cutout works vs the old magic-wand method, best source photos (clear subject/edges), use cases (e-commerce, avatars, stickers), and privacy. Step-by-step. Note RU/UZ localized pages exist.",
    related: ["upscale-image-quality-ai-free", "extract-text-from-image-ocr"],
  },
  {
    slug: "upscale-image-quality-ai-free",
    title: "How to Improve Photo Quality With AI (Free Upscaler)",
    description: "Turn a small or blurry photo into a sharper, higher-resolution image with AI — free, online, no signup. Great for old photos and low-res downloads.",
    keywords: ["improve photo quality", "ai image upscaler free", "increase image resolution", "enhance blurry photo", "upscale image online"],
    category: "AI", toolHref: "/ai-tools/image-upscaler", toolLabel: "Upscale a photo free",
    angle: "How AI upscaling reconstructs detail (vs simple resizing), realistic expectations (2–4×), best inputs, and when to also denoise. Walkthrough with QRix.",
    related: ["remove-background-from-image-free", "extract-text-from-image-ocr"],
  },
  {
