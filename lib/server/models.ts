...
export interface DeviceSession { id: string; userId: string; token: string; ip?: string | null; userAgent?: string | null; rememberMe: boolean; expiresAt: string; createdAt: string; }
