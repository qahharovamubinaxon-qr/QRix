...
const COPY: Record<string, Copy> = {
  ...
  rutube: {
    title: "Rutube Downloader — Save Rutube Videos as MP4",
    h1: "Rutube Video Downloader",
    desc: "Download Rutube videos as MP4 in up to 1080p — free, no account. Скачать видео с Rutube бесплатно, в хорошем качестве.",
    intro: "Save public Rutube videos as MP4 files in any quality the upload offers, from 144p to 1080p. Paste the link, choose a size, and QRix assembles the video and converts it in your browser.",
    keywords: ["rutube downloader", "скачать видео с rutube", "rutube скачать", "download rutube video", "rutube mp4"],
    features: [
      ["Six qualities", "Everything Rutube publishes, from 144p to 1080p."],
      ["Real MP4", "Rutube streams in fragments; QRix reassembles them into one MP4 file."],
      ["No account", "Only public videos are read, and you never log in."],
      ["Nothing installed", "It runs in the browser — no app, no extension."],
    ],
    faqs: [
      { q: "How do I download a Rutube video?", a: "Copy the video's link (rutube.ru/video/…), paste it above, and pick a quality. The MP4 saves to your device." },
      { q: "Why is a long video slow?", a: "Rutube delivers video in fragments, so the file is rebuilt in your browser after it downloads. Choosing a lower quality is much faster on long videos, and far kinder to a phone." },
      { q: "What is the best quality available?", a: "Up to 1080p, when the uploader published it at that size. QRix lists exactly what exists — it never offers a size the video does not have." },
      { q: "Do private videos work?", a: "No. Only videos that anyone can open are readable." },
    ],
    steps: genericSteps("rutube", "Rutube"),
  },
  telegram: {
    title: "Telegram Video Downloader — Save Videos from Public Channels",
    h1: "Telegram Video & Photo Downloader",
    desc: "Download videos and photos from public Telegram channels as MP4 or JPG — free, no account, no app. Скачать видео из Telegram.",
    intro: "Save media from public Telegram posts. Paste a t.me link and QRix pulls the original video or photo straight from Telegram's own servers — nothing is re-encoded.",
    keywords: ["telegram video downloader", "скачать видео из телеграм", "t.me download", "download telegram video", "telegram media download"],
    features: [
      ["Original quality", "The file is Telegram's own — not a recompressed copy."],
      ["Video and photos", "Both save, in whatever format the post used."],
      ["No account", "You never sign in, and no message is ever read on your behalf."],
      ["Any device", "Works in a phone browser as well as on a desktop."],
    ],
    faqs: [
      { q: "How do I download a Telegram video?", a: "Open the post in a browser or tap Share → Copy Link to get a t.me/channel/123 link, paste it above, then save the file." },
      { q: "Can I download from a private channel?", a: "No. Only public channels have a working t.me link, and only those can be read — a private channel's media stays private." },
      { q: "Does the person know I downloaded it?", a: "No. QRix reads the public post the same way opening the link in a browser does." },
      { q: "Is the quality reduced?", a: "No. The original file is passed through untouched, so what you save is what was posted." },
    ],
    steps: genericSteps("telegram", "Telegram"),
  },
  pinterest: {
