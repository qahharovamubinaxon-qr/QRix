...
const PROMOS: Promo[] = [
  ...
  { title: "✍️ OCR — Image to Text", href: "/image-tools/image-to-text",
    en: "Pull editable text out of any photo or scan — 100+ languages.",
    ru: "Извлеките текст из фото или скана — 100+ языков.",
    uz: "Rasm yoki skandan matnni ajratib oling — 100+ til.",
