...
export const metadata = pageMeta({ title: "PDF to Word — Free Online Tool", description: "Convert PDF documents into editable Word files.", path: "/pdf-tools/pdf-to-word", languages: { en: "/pdf-tools/pdf-to-word", ru: "/ru/pdf-to-word", uz: "/uz/pdf-to-word", "x-default": "/pdf-tools/pdf-to-word" } });
